 ...
 * [Зеркальные каталоги](#Зеркальные каталоги)
 ...
 Показать полную конфигурацию JSON для соединения. **ВНИМАНИЕ** ключи и секреты будут выводиться на стандартный вывод.
 ...
 **Примечание о зашифрованном хранилище**: рекурсивный список пока не поддерживается для зашифрованных соединений.
 ...
 ### Зеркальные каталоги
 Зеркальное отображение — это больше, чем частный случай `cp` , это отдельная команда mobiletto, обертывающая
 ...
 Чтобы отразить подкаталог в другой подкаталог:
